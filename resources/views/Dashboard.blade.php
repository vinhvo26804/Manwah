                ...
                <ul class="nav flex-column">
                    <li class="nav-item mb-2">
                        <a href="{{ route('Dashboard') }}"
                            class="nav-link text-white {{ request()->is('dashboard') ? 'active fw-bold' : '' }}">
                            🏠 Dashboard
                        </a>
                    </li>
                    <li class="nav-item mb-2">
                        <a href="{{ route('users.index') }}"
                            class="nav-link text-white {{ request()->is('users*') ? 'active fw-bold' : '' }}">
                            👤 Quản lý Users
                        </a>
                    </li>
                    <li class="nav-item mb-2">
                        <a href="{{ route('products.index') }}"
                            class="nav-link text-white {{ request()->is('products*') ? 'active fw-bold' : '' }}">
                            📦 Quản lý Products
                        </a>
                    </li>
