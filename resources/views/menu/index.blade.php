                    ...
                    <div class="card shadow-sm h-100 rounded-3">
                        ...
                        <div class="card-body d-flex flex-column justify-content-between">
                            <div>
                                ...
                                <p class="card-text text-danger fw-bold">{{ number_format($product->price, 0, '.', '.') }} VND
                                </p>
                            </div>
                            ...
                            <form action="{{ route('cart.add', $product->id) }}" method="POST" class="add-to-cart-form mt-2">
                                ...
                                <div class="quantity-control d-flex align-items-center justify-content-center mb-2">
                                    ...
                                    <input type="text" name="quantity" value="0" readonly
                                        class="form-control quantity-input mx-2 text-center" style="width: 50px;">
                                    <button type="button"
...
@section('scripts')
    <script>
        document.addEventListener('DOMContentLoaded', function () {
            ...
            // Chuyển hướng khi chọn danh mục
