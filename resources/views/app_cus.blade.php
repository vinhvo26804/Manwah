...
<body>
    ...
    <nav class="navbar navbar-expand-lg navbar-dark bg-dark">
        <div class="container">
            ...
            @auth
                {{-- CHỈ hiển thị navbar toggle và menu khi KHÔNG phải customer --}}
                @if(!Auth::user()->isCustomer())
                    ...
                    <div class="collapse navbar-collapse" id="navbarNav">
                        <ul class="navbar-nav me-auto">
                            ...
                            {{-- CHỈ hiển thị menu Thực Đơn và Giỏ Hàng cho Admin/Staff --}}
            ...
            <ul class="navbar-nav">
                ...
                @else
                    {{-- Menu dropdown cho người đã đăng nhập --}}
